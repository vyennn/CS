...
<body>
    ...
    <a href="dashboard_security.php" class="active"><i class="fas fa-home"></i> Dashboard</a>
    ...
    <h3 style="margin-top: 20px; color: #117126;text-align:center;">Dashboard</h3>
    <hr style="border: none; height: 2px; background-color: #117126;margin:20px 80px;">
    ...
    <br><br>
    <h4 style="margin-top: 30px; color:rgb(186, 178, 178); text-align:center; font-family: sans-serif;">
